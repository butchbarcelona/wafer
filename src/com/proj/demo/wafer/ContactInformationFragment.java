...
public class ContactInformationFragment extends BaseFragment implements BaseActivity.USBConnectListener {


    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {

        View v = inflater.inflate(R.layout.activity_contact_information, null);
        return v;
    }
